    ...
    <section class="text-center bg-pinkDark">
        ...
        <section class="max-w-8xl flex flex-wrap items-center mx-auto">
            ...
            <div class="flex flex-wrap justify-center items-center my-16 mx-auto">
                ...
                <p class="md:text-1xl text-center text-wht p-4 w-full md:mx-40 xl:mx-60">{{ $post->content }}</p>
                @endif
                ...
                <div class="relative">
                    ...
                    <h3 class="block absolute bottom-0 left-0 right-0 text-3xl text-pinkLight pt-2">{{ $post->title
                        }}</h3>
                    @endif
                </div>
                @if(!empty($post->content))
                <div
                    ...
                    <p class="text-start md:text-1xl">{{ $post->content }}</p>
                </div>
                @endif
                ...
                <div
                    class="flex flex-col justify-center items-start min-h-[300px] sm:w-[600px] text-wht bg-pinkDark px-8 py-4">
                    <h3 class="text-start text-3xl md:text-6xl pb-2">{{ $post->title }}</h3>
                    <p class="text-start md:text-1xl">{{ $post->content }}</p>
                </div>
                @endif
                <div>
