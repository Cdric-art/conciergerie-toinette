<x-app-layout>
    ...
    <div class="relative max-w-[82vw] left-[240px] top-[16px] mb-8 shadow-md sm:rounded-lg">
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500">
            ...
            <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 border-b">
                ...
                <td class="px-4 py-4">
                    <img class="w-1/4" src="{{ asset('storage/images/' . $homePost->image) }}" alt="{{ $homePost->image }}">
                </td>
                <td class="px-4 py-4">
