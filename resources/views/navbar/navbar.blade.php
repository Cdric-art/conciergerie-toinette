<nav class="bg-wht border-gray-200">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-multi-level">
            <ul class="flex flex-col p-4 md:p-0 mt-4 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
                <li>
                    <a href="{{ route('services') }}" class="block py-2 px-3 text-pinkDark border border-pinkDark rounded">Services au quotidien</a>
                </li>
                {{--
                <li>
                ...
                --}}
                <li>
                    <a href="#" class="block py-2 px-3 text-pinkDark border border-pinkDark rounded">Conciergerie AirBnb</a>
                </li>
                <li>
                    <a href="#" class="block py-2 px-3 text-pinkDark border border-pinkDark rounded">À propos</a>
                </li>
            </ul>
        </div>
        <div class="hidden w-full md:block md:w-auto" id="navbar-multi-level">
            <ul class="flex flex-col bg-pinkDark text-wht text-center p-4 mt-4 rounded-lg">
                <li>
